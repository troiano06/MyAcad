            ...
            <div class="mt-4">
                ...
                <!--<div class="flex flex-wrap items-stretch w-full mb-4 relative">
                    ...
                    <div class="flex -mr-px">
                        <span class="flex items-center leading-normal bg-grey-lighter rounded rounded-l-none border border-l-0 border-grey-light px-3 whitespace-no-wrap text-grey-dark text-sm">@fatec.sp.gov.br</span>
                    </div>
                </div>-->
            </div>
